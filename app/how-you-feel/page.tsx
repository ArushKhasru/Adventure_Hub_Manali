...
import { ArrowRight, Check, Compass, Heart, Mountain, Sparkles } from "lucide-react";
...
const moods = [
  { number: "01", title: "I want to\nunwind", eyebrow: "A softer side of Manali", copy: "Make room for slow mornings, warm cafés, a good view, and a stay that feels easy from the moment you arrive.", href: "/hotel", label: "Find a stay", icon: Heart, image: "/images/manali-walk/frames/ezgif-frame-052.jpg", accent: "bg-[#dcece2] text-[#174b3c]" },
  { number: "02", title: "I want\nadventure", eyebrow: "Turn up the mountain air", copy: "Chase the rush with river time, wide-open trails, snow days, and stories you will be retelling on the ride home.", href: "/activities", label: "Explore activities", icon: Mountain, image: "/images/manali-walk/frames/ezgif-frame-028.jpg", accent: "bg-[#e9d7bd] text-[#174b3c]" },
  { number: "03", title: "I want to\nexplore", eyebrow: "Follow your curiosity", copy: "Piece together a day of valley roads, village stops, viewpoints, and the places that make Manali linger with you.", href: "/travel", label: "Plan a route", icon: Compass, image: "/images/manali-walk/frames/ezgif-frame-070.jpg", accent: "bg-[#d8e8e7] text-[#174b3c]" },
];
